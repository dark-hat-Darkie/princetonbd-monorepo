  ...
  return (
    <div className="border-t border-t-line">
      {items.map((item) => (
        ...
        >
          <summary className="flex cursor-pointer list-none items-start justify-between gap-6 py-[22px] font-display text-[19px] leading-[1.35] font-semibold tracking-[-.01em] text-ink transition-colors duration-200 marker:content-[''] hover:text-brand-ink">
            {item.question}
            <span
              aria-hidden
              className="relative mt-2 size-3.5 flex-none text-brand-ink before:absolute before:top-1/2 before:left-0 before:h-[1.5px] before:w-full before:-translate-y-1/2 before:bg-current before:content-[''] after:absolute after:top-1/2 after:left-0 after:h-[1.5px] after:w-full after:-translate-y-1/2 after:rotate-90 after:bg-current after:transition-transform after:duration-200 after:content-[''] group-open:after:rotate-0"
            />
          </summary>
